          ...
          <div class="col-md-12">
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                <h3 class="text-uppercase">Authentification à <strong>BibliothéqueFSBM</strong></h3>
              </div>
              <form action="authentification" method="post">
                ...
                <input type="submit" value="S'authentifié" class="btn btn-block py-2 btn-primary">
              </form>
            </div>
          </div>
        </div>
